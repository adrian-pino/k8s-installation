...
# VARIABLES
################################
# K8S_VERSION=x.x.x.x (e.g: 1.28.2-1.1)                 # Needed for master and worker installation
...
# POD_CIDR=172.12.0.0/16      				# Needed for master installation (not used in worker installation)
################################
